...
public class SfffApp {

    private static final Logger log = LoggerFactory.getLogger(SfffApp.class);

    private final Environment env;

    public SfffApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SfffApp.class);
